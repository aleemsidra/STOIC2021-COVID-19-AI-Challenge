...
class Logger:
    ...
    def __init__(self, config, model_dir):
        ...
        self.train_summary_dir = os.path.join(os.path.dirname(os.path.dirname(__file__)), model_dir, "train")
        self.validate_summary_dir = os.path.join(os.path.dirname(os.path.dirname(__file__)), model_dir, "val")
