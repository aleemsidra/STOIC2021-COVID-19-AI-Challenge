...
class ResNet(nn.Module):
    ...
    def __init__(self, block, layers, num_classes=1000, fc_layer=True):
        self.inplanes = 64
...
def resnet18(**kwargs):
    ...
    fc_layer = kwargs.get('fc_layer')
    
    model = ResNet(BasicBlock, [2, 2, 2, 2], num_classes=num_classes, fc_layer=fc_layer)
    return model
